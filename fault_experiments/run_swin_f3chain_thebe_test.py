...
OUTPUT_ROOT = ROOT / "runs/thebe_final_test2_7/swin_unetr_f3chain"
CHECKPOINT = ROOT / "checkpoints/swinunetr_f3chain_thebe_e8.pt"
THRESHOLD = 0.40
...
def main():
    ...
    for index in range(2, 8):
        ...
        command = [
            ...
            str(THRESHOLD),
            "--threshold-source",
            "official Thebe val1-val2; matched synthetic-F3-Thebe chain",
            "--output-dir",
            str(output_dir),
            "--stride",
            "64",
